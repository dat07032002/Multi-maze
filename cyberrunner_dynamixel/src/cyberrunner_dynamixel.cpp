...
int32_t limit_command(double value, int32_t max_abs)
{
...
void set_dynamixel_speed(
    const cyberrunner_interfaces::msg::DynamixelVel::SharedPtr msg,
    int32_t max_vel_1,
    int32_t max_vel_2)
{
    ...
    moving_speeds[0] = limit_command(msg->vel_1, max_vel_1);
    moving_speeds[1] = limit_command(msg->vel_2, max_vel_2);
...
int main(int argc, char** argv)
{
    ...
    int32_t max_vel_1 = node->declare_parameter<int>("max_vel_1", 300);
    int32_t max_vel_2 = node->declare_parameter<int>("max_vel_2", 300);
    RCLCPP_INFO(
        node->get_logger(),
        "Limiting Dynamixel commands to max_vel_1=%d max_vel_2=%d",
        max_vel_1,
        max_vel_2);
    rclcpp::Subscription<cyberrunner_interfaces::msg::DynamixelVel>::SharedPtr sub =
        node->create_subscription<cyberrunner_interfaces::msg::DynamixelVel>(
            "cyberrunner_dynamixel/cmd",
            1,
            [max_vel_1, max_vel_2](const cyberrunner_interfaces::msg::DynamixelVel::SharedPtr msg) {
                set_dynamixel_speed(msg, max_vel_1, max_vel_2);
            });
