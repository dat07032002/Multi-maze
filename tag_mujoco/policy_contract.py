...
class TagPolicyContract:
    ...
    angle_scale_rad: float = math.radians(10.0)
    ...
    bridge_command_limit: tuple[float, float] = (180.0, 180.0)
    ...
    def normalize_states(
        ...
        Angles are divided by 10 degrees.  Positions are divided by the board
